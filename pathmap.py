...
def epimmPathMap():
    ...
    dir_api = os.path.abspath(os.path.join(dir_epiMM,"api"))
    dir_datum = os.path.abspath(os.path.join(dir_epiMM, 'datum'))
    # fetches path to the CSV data folder
    dir_who = os.path.abspath(os.path.join((dir_epiMM), 'datum/who'))   
    ...
    return dir_api, dir_datum, dir_epiMM, dir_who, dir_log, dir_scripts, dir_test
